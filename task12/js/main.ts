namespace task12 {
    ...
    let fps: number = 30;
    export let SuperklasseArray: Superklasse[] = [];
    ...
    function init() {
        ...
        for (let i: number = 0; i < 19; i++) {
            let bubbles: Superklasse = new Superklasse(Math.random());
            SuperklasseArray.push(bubbles)
            /*let x: number = Math.random() * canvas.width;
        ...
        for (let i: number = 0; i < 19; i++) {
            let bubbles1 : BubbleInterface1 = new BubbleInterface1();
            SuperklasseArray.push(bubbles1);
        ...
        for (let i: number = 0; i < 8; i++) {
            let fish: FischInterface = new FischInterface();
            SuperklasseArray.push(fish);
            /*let x: number = Math.random()*canvas.width;
            let y: number = Math.random()*canvas.height;
            let dx: number = -10;
            let dy: number = 0;
        ...
        for (let i: number = 0; i < 8; i++) {
            let fish1: FischInterface1 = new FischInterface1();
            SuperklasseArray.push(fish1);
